...
export const EMAIL_SMTP_PASS: string = process.env.EMAIL_SMTP_PASS || "Nasution02A!";
...
export const EMAIL_SMTP_HOST: string = process.env.EMAIL_SMTP_HOST || "rydhlnst@gmail.com";
